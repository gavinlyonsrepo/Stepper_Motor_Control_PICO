 ...
 * @brief test file Stepper motor control library for Raspberry Pi Pico.
		Bipolar Nema Stepper motor LV8729 controller
...
int main()
{
	...
	std::cout << " 1 Full 360 turn Test1" << std::endl;
	motor.motorGo(false, "Full", 200, 10, true, 50); //~ 2 seconds
	busy_wait_ms(1000);
	EndTest();
	return 0;
}
